...
// NewBdForumGenAPI creates a new BdForumGen instance
func NewBdForumGenAPI(spec *loads.Document) *BdForumGenAPI {
	return &BdForumGenAPI{
...
/*BdForumGenAPI Тестовое задание для реализации проекта "Форумы" на курсе по базам данных в
Технопарке Mail.ru (https://park.mail.ru).
*/
type BdForumGenAPI struct {
	spec            *loads.Document
...
func (o *BdForumGenAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *BdForumGenAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *BdForumGenAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *BdForumGenAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *BdForumGenAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *BdForumGenAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *BdForumGenAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the BdForumGenAPI
func (o *BdForumGenAPI) Validate() error {
...
func (o *BdForumGenAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *BdForumGenAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *BdForumGenAPI) Authorizer() runtime.Authorizer {
...
func (o *BdForumGenAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *BdForumGenAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *BdForumGenAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the bd forum gen API
func (o *BdForumGenAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *BdForumGenAPI) initHandlerCache() {
...
func (o *BdForumGenAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *BdForumGenAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *BdForumGenAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
